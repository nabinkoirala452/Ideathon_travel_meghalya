...
  const { dispatch } = useContext(AuthContext); // Removed `role` since it's not needed in this component
...
        type: "LOGIN_SUCCESS",
        payload: {
          user: { name: "Admin User", email: "admin" }, // Placeholder user data
          token: "fake-admin-token", // Placeholder token
          role: "admin",
        },
      });
